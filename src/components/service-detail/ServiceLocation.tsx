  ...
  return (
    ...
    >
      <div style={{ maxWidth: '680px', marginBottom: 'var(--space-8)' }}>
        ...
        >
          <School size={13} color="var(--color-brand-blue, #0F382C)" />
      ...
      >
        <div>
          <div style={{ fontSize: '0.75rem', fontFamily: 'var(--font-mono)', color: 'var(--color-brand-blue, #0F382C)', fontWeight: 700, textTransform: 'uppercase', marginBottom: '0.35rem' }}>
            Hub Operations Base
          </div>
          <h3 style={{ fontSize: '1.25rem', fontFamily: 'var(--font-serif, "Domine", serif)', fontWeight: 600, color: 'var(--color-text-primary, #151D1A)', margin: '0 0 var(--space-3) 0' }}>
            {activeCampus.hubLocation}
          </h3>
          <p style={{ fontSize: '0.86rem', color: 'var(--color-text-secondary, #414845)', lineHeight: 1.6, margin: '0 0 var(--space-4) 0' }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', fontSize: '0.8rem', color: 'var(--color-brand-blue, #0F382C)' }}>
            <Navigation size={14} />
            <span>Average transit to your room: <strong>{service.metrics.avgDeliveryTime}</strong></span>
          </div>
        </div>

        <div style={{ backgroundColor: '#f3fbf5', padding: 'var(--space-6)', borderRadius: 'var(--radius-xl)', border: '1px solid var(--color-border-subtle, #E8E4D5)' }}>
          <div style={{ fontSize: '0.78rem', fontFamily: 'var(--font-sans)', fontWeight: 700, color: 'var(--color-text-primary, #151D1A)', marginBottom: 'var(--space-3)' }}>
            Covered University Zones:
          </div>
          <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.85rem', color: 'var(--color-text-secondary, #414845)' }}>
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ color: 'var(--color-brand-blue, #0F382C)' }}>•</span>
